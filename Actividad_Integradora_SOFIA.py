...
def get_data_from_csv():
    ...
    df = df.replace({"": "None"})
    df = df.rename(columns={'Incident Year': 'Incident_Year', 'Incident Day of Week': 'Incident_Day_of_Week', 'Analysis Neighborhood': 'Analysis_Neighborhood', 'Incident ID': 'Incident_ID', 'Incident Subcategory': 'Incident_SubCategory', 'Incident Time': 'Incident_Time','Incident Number': 'Incident_Numbers', 'Incident Date': 'Incident_Date',  'Incident Category': 'Incident_Category'})
    #st.dataframe(df)
